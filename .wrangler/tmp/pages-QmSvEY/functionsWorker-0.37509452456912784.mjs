...
// api/tables/[id]/archive.js
var onRequestPost = /* @__PURE__ */ __name(async ({ env, params }) => {
  const id = params.id;
...
// api/tables/[id]/rows.js
var onRequestPost2 = /* @__PURE__ */ __name(async ({ env, params, request }) => {
...
// api/tables/[id]/unarchive.js
var onRequestPost3 = /* @__PURE__ */ __name(async ({ env, params }) => {
  const id = params.id;
  const now = (/* @__PURE__ */ new Date()).toISOString();
...
// api/tables/[tableId]/apply-phones.js
var onRequestGet = /* @__PURE__ */ __name(async ({ env, params }) => {
  const { tableId } = params;
  const ensureSchema3 = /* @__PURE__ */ __name(async (db) => {
    await db.prepare(`
...
// api/tables/[tableId]/rows.js
var onRequestPost4 = /* @__PURE__ */ __name(async ({ env, request, params }) => {
  const { tableId } = params;
  const ensureSchema3 = /* @__PURE__ */ __name(async (db) => {
    await db.prepare(`
      CREATE TABLE IF NOT EXISTS rows (
...
// api/tables/[tableId]/seed-nouvel-an.js
...
// api/tables/[tableId]/update-phones.js
var onRequestPost5 = /* @__PURE__ */ __name(async ({ env, params, request }) => {
  const { tableId } = params;
  const ensureSchema3 = /* @__PURE__ */ __name(async (db) => {
    await db.prepare(`
      CREATE TABLE IF NOT EXISTS rows (
...
// api/tables/[tableId]/settings.js
var onRequest2 = /* @__PURE__ */ __name(async ({ env, request, params }) => {
  const { tableId } = params;
  const ensureSchema3 = /* @__PURE__ */ __name(async (db) => {
    await db.prepare(`
...
var onRequestPatch2 = /* @__PURE__ */ __name(async ({ env, params, request }) => {
  const id = params.id;
  const body = await request.json();
  const now = (/* @__PURE__ */ new Date()).toISOString();
...
// api/tables/index.js
var ensureSchema2 = /* @__PURE__ */ __name(async (db) => {
  await db.prepare(`
    CREATE TABLE IF NOT EXISTS tables (
      id TEXT PRIMARY KEY,
      name TEXT NOT NULL,
...
// ../.wrangler/tmp/pages-QmSvEY/functionsRoutes-0.32272889356283907.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-AnW6pY/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-AnW6pY/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.37509452456912784.mjs.map
