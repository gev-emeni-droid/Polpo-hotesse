      ...
      <html>
        <head>
          ...
          <style>
            ...
            .cta-button { display: inline-block; padding: 12px 24px; background-color: ${themeColor || '#007bff'}; color: white !important; text-decoration: none; border-radius: 5px; font-weight: bold; }
