-- Migration des données de l'ancienne base vers la nouvelle

-- Insertion des calendriers
INSERT INTO hotesse_calendars (id, month, year, title, created_at, is_archived)
VALUES 
...
INSERT INTO hotesse_hostess_options (id, name)
VALUES 
  (1, 'Emeni'),
  (2, 'Shelihane'),
  (3, '1 LBE'),
...
INSERT INTO hotesse_prise_par_options (id, name)
VALUES 
  (1, 'Juliette'),
  (3, 'Maëlle');
...
INSERT INTO hotesse_privatisations_hostesses (priv_id, hostess_name)
VALUES 
